...
const BarcodeScanner = ({ onScan, onError, isActive = true }) => {
    ...
    // Gestion de l'activation/désactivation réelle de la caméra
    useEffect(() => {
                        ...
                        onClick={async () => {
                            if (scannerRef.current) {
                                try {
                                    ...
                                    // Even if it fails, try to set stopped to free UI
                                    setStatus('stopped');
                                }
                            }
                        }}
